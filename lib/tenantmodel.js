...
class TenantModel extends events.EventEmitter {
    ...
    getModelsList () {
        ...
        modelsList = modelsList.concat(this.getModelsForPath(path.normalize(path.dirname(__dirname) + '/app/models/tenant/')));
        // modelsList = modelsList.concat(this.getModelsForPath(path.normalize(path.dirname(__dirname) + '/app/models/')));
    ...
    getModelsForPath (modelsPath) {
        ...
        this._logger.info('## Checking tenant models in the dir: %s', normalizedPath);
