...
class MultiTenantsHostController extends events.EventEmitter {
    ...
    startHostController (hostController, callback) {
        var $this = this;
        console.log('$$$$ Initializing Multitenants Host Controller. %s', hostController);
    ...
    /**
     * Stop host controller for Multiple Tenants
     *
     * @param callback
     */
    stopHostController (callback) {
        var $this = this;
        if (this._io != null) {
            console.log('$$$$ Stopping Multitenants Host Controller.');
            if (this._io.server) {
